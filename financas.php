...
var outro_inp = document.getElementsByClassName("canvasjs-chart-credit");
            for( i=0; i < outro_inp.length; i++){
                outro_inp[i].innerHTML =  '';
            } 
}
...
<body>
<script src="javascript/financas.js" defer></script>
<script src="dependencias\bootstrap.bundle.min.js"></script>
<?php
         readfile('Assets/side_bar.html');
?>
...
<div class="alerta" id="Alert">
    ...
    <script src="dependencias\canvasjs.min.js"></script>
    ...
    <div id="table-div" class=" bg-light finan-tab" style="border:1px solid black;"> 
		...
		<div class="offcanvas offcanvas-end " id="register-div" style="background-color:rgb(0,0,0, 0.01); border:0px; width:100%; height: 100%;">
			...
			<form class="form bg-light" method="POST" action="financas.php" id="register-form">
				...
				<div class="box">
					<input id="ganhos" name="ganhos"/>
					<label for="ganhos">Ganhos</label>
				</div>
				
				<div class="box">
					<input id="gastos" name="gastos"/>
