...
<script>
	...
	$(document).ready(function(){
		...
		{
			$.ajax({
			url:"php_arquivos/estoque/pesquisarProdutos.php",
			method:"POST",
			data:{query:query},
...
<div class="app-container">
  ...
  <div class="app-content">
    <div class="app-content-header">
      ...
      <button class="app-content-headerButton" data-bs-toggle="offcanvas" data-bs-target="#register-div" >Adicionar produto</button>
    </div>
...
<!-- partial -->
  ...
  <div class="offcanvas offcanvas-end " id="register-div" style="background-color:rgb(0,0,0, 0.01); border:0px; width:100%; height: 100%;">
			...
			<form class="form" method="POST" action="estoque.php" id="register-form">
				...
				<div class="box">
					<input type="" id="preco" name="preco" required/>
