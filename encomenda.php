...
<script>
	...
	$(document).ready(function(){
		...
		{
			$.ajax({
			url:"php_arquivos/encomendas/pesquisarEncomendas.php",
			method:"POST",
			data:{query:query},
...
<script src="javascript/encomenda.js"></script>
...
<div class="app-container">
  ...
  <div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">Encomendas</h1>
      ...
      <button class="app-content-headerButton" data-bs-toggle="offcanvas" data-bs-target="#register-div" >Adicionar encomenda</button>
    </div>
...
<!-- partial -->
  ...
  <div class="offcanvas offcanvas-end " id="register-div" style="background-color:rgb(0,0,0, 0.01); border:0px; width:100%; height: 100%;">
            ...
            ?>
             <form style="display:block" class="form" method="POST" action="php_arquivos/encomendas/cadastrarEncomenda1.php" id="register-form">
